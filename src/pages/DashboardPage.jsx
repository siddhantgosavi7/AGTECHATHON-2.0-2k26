  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-10">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <StatCard icon={ScanLine} label="Total scans performed" value="326" />
        <StatCard icon={ShieldCheck} label="Crop health score" value="84%" />
        <StatCard icon={Bell} label="Weather risk alerts" value="3" />
        <StatCard icon={CalendarDays} label="Farming reminders" value="5" />
      </div>
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          ...
          <div className="grid gap-3">
            {['Spray preventive fungicide in tomato plot', 'Check drip irrigation filter', 'Book soil test for next week'].map((item) => (
